...
<!-- ============ WHY CHOOSE US ============ -->
 <!-- //////// wala section ka content shoow n hur  -->
<section class="section">
  <div class="container">

    <div class="text-center mb-5">
      <h2 class="section-title">Why clients choose LegalEase</h2>
      <p class="text-muted-legal mb-0">
        A transparent, verified and secure way to get legal help.
      </p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="card-legal h-100 p-4">
          ...
          <p class="text-muted-legal mb-0">
            Every profile is checked against Bar Council records,
            qualifications and practice history before it goes live.
          </p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card-legal h-100 p-4">
          ...
          <p class="text-muted-legal mb-0">
            See real availability, pick a morning or evening slot and
            receive instant confirmation — no phone tag required.
          </p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card-legal h-100 p-4">
          ...
          <p class="text-muted-legal mb-0">
            Encrypted case notes, private video rooms and confidential
            document sharing protected by attorney-client privilege.
          </p>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row text-center g-4 text-white">
      <div class="col-6 col-lg-3">
        <div class="h3 text-gold mb-0">1,200+</div><small class="opacity-75">Verified lawyers</small>
      </div>
      <div class="col-6 col-lg-3">
        <div class="h3 text-gold mb-0">38,400</div><small class="opacity-75">Consultations booked</small>
      </div>
      <div class="col-6 col-lg-3">
        <div class="h3 text-gold mb-0">24 cities</div><small class="opacity-75">Nationwide coverage</small>
      </div>
      <div class="col-6 col-lg-3">
        <div class="h3 text-gold mb-0">4.8/5</div><small class="opacity-75">Average client rating</small>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-end mb-4 gap-3 fade-up">
      <div>
        ...
        <p class="text-muted-legal mb-0">
          Top-rated advocates accepting appointments this week.
        </p>
      </div>

      <a href="{{ route('lawyerfind') }}" class="btn btn-outline-navy">
        Browse all lawyers
      ...
      <div class="col-md-6 col-lg-4">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-3 h-100 bg-white d-flex flex-column justify-content-between">
          ...
          <a
            ...
            class="btn btn-dark w-100 py-2 rounded-3 fw-semibold mt-2">
